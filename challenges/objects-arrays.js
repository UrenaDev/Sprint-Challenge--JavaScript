...
zooAnimals.map(arrItem => lowCaseAnimalNames.push(arrItem.animal_name.toLowerCase()));
...
*/
const populationTotal = zooAnimals.reduce((sum, arrItem) => sum + arrItem.population, 0);
